...
<section class="relative h-[90vh] overflow-hidden">
    <img src="{{ asset('/images/logo-02.jpg') }}" alt="logo" class="absolute inset-0 w-full h-full object-cover brightness-50 z-0">
        ...
        <div class="relative overflow-hidden h-64 md:h-full scroll-container">
            <div class="absolute animate-scroll-down space-y-4">
                @foreach(range(1,10) as $i)
                    <img src="{{ asset('/images/img' . $i . '.jpg') }}" alt="Image {{ $i }}" class="w-full rounded-lg shadow-lg">
                @endforeach
            </div>
        </div>
